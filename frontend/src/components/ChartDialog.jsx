...
export const ChartDialog = ({ open, onOpenChange, selectedCrypto, chartData, chartDays, onChangeDays }) => {
  const gradientId = useMemo(() => "chartGradient", []);
        ...
        <div className="space-y-4">
          ...
          <ResponsiveContainer width="100%" height={400}>
            <AreaChart data={chartData}>
              ...
              <Area type="monotone" dataKey="price" stroke="#007AFF" strokeWidth={2} fill={`url(#${gradientId})`} dot={false} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </DialogContent>
